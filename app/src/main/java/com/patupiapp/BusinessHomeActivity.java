    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(menuItem -> {
            ...
            if(itemId == R.id.NavHome){
                loadFragment(new BusinessFragment(), false);
        ...
        loadFragment(new BusinessFragment(), true);
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (userProfile != null) {
                    ...
                    String business = userProfile.business;

                    // Check if the business field is not empty
                    if (!TextUtils.isEmpty(business)) {
                        fname.setText(business); // Display the business instead of the name
                    } else {
                        fname.setText(name); // Fallback to name if business is empty
                    }

                    // Uncomment this if you want to display email elsewhere
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BusinessHomeActivity.this, "Error!", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            fusedLocationClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
                ...
                public void onSuccess(android.location.Location location) {
                    if (location != null) {
                        ...
                        String country = getCountryName(BusinessHomeActivity.this, latitude, longitude);
                        String province = getProvinceName(BusinessHomeActivity.this, latitude, longitude);
